...
import app.generated.picture.PictureModels
...
class PictureSerialize extends SerializerWithStringManifest {
  ...
  val PictureCreatedManifestOld = "com.adelegue.mypictures.domains.picture.Pictures$PictureCreated"
  val PictureCreatedManifest = classOf[PictureCreated].getName
  val PictureUpdatedManifestOld = "com.adelegue.mypictures.domains.picture.Pictures$PictureUpdated"
  val PictureUpdatedManifest = classOf[PictureUpdated].getName
  val PictureDeletedManifestOld = "com.adelegue.mypictures.domains.picture.Pictures$PictureDeleted"
  ...
  override def fromBinary(bytes: Array[Byte], manifest: String): AnyRef = manifest match {
    case PictureCreatedManifest | PictureCreatedManifestOld =>
      pictureCreated(PictureModels.PictureCreated.parseFrom(bytes))
    case PictureUpdatedManifest | PictureUpdatedManifestOld =>
      pictureUpdated(PictureModels.PictureUpdated.parseFrom(bytes))
    case PictureDeletedManifest | PictureDeletedManifestOld =>
