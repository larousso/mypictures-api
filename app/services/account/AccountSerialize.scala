...
import app.generated.account.AccountModels
...
class AccountSerialize extends SerializerWithStringManifest {
  ...
  val AccountAddedManifestOld = "com.adelegue.mypictures.domains.account.Accounts$AccountAdded"
  ...
  override def fromBinary(bytes: Array[Byte], manifest: String): AnyRef = manifest match {
    case AccountAddedManifest | AccountAddedManifestOld =>
